...
class Producto(db.Model):
    ...
    def __init__(self, descripcion, precio_id, estado_producto_id, tipo_producto_id):
        """
        Constructor de la clase producto
        """
        self.descripcion = descripcion
        self.precio_id = precio_id
        self.estado_producto_id = estado_producto_id
...
=======
        return 'productos {}'.format(self.descripcion, self.precio_id, self.estado_producto_id, self.tipo_producto_id)
