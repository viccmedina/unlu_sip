...
CONSULTA_STOCK = """ SELECT pe.stock_real FROM producto_envase pe WHERE pe.producto_id = {producto_id}  """
...
CONSULTAR_ID_PRODUCTO = """ SELECT (pe.producto_id) FROM producto p INNER JOIN
